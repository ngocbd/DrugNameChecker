...
public class DrugNameChecker {

	private static Logger log = Logger.getLogger(DrugNameChecker.class.getName());
	...
	static {
		DrugNameTree.createTree(tst);
	}
	
	public static void main(String[] args) {
		DrugNameChecker checker  = new DrugNameChecker();
		
		Map map = checker.correct("uýp Tra m");
